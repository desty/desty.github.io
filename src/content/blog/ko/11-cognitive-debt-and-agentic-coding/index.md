---
title: "AI 코딩의 경고등이 켜졌다 — 그래서 우리는 어떻게 할 것인가"
summary: "인지 부채, 토큰 비용 과열, 기술 위축 논쟁을 정면으로 분석하고, 변화하는 시대에 개발자가 실제로 취해야 할 전략을 정리한다."
...
최근 개발자 커뮤니티에서 "Agentic Coding은 함정이다", "인지 부채가 쌓이고 있다", "토큰 비용이 지속 가능하지 않다" 같은 경고의 목소리가 빠르게 퍼지고 있다. [GeepawHill의 글](https://www.geepawhill.org/2025/05/02/agentic-coding-is-a-trap/)이 대표적이고, 여러 시니어 개발자들이 비슷한 우려를 제기한다.
