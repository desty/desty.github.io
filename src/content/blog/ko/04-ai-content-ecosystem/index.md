...
데이터는 이 방향을 가리키고 있다. 문제는 그 사이에서 개인 크리에이터와 소규모 퍼블리셔가 트래픽 절벽을 버틸 수 있느냐다. 이 변화에 어떻게 대응할 것인가 — 구체적인 전략은 [GEO — SEO의 다음 단계, AI에게 인용되는 콘텐츠 만들기](/blog/05-geo-seo)에서 다뤘다.
