...
공통 원리는 하나다 — **윈도우는 "지금 이 순간 필요한 것"만 담는 작업대다.** 끝난 것은 압축하고, 다 쓴 것은 비우고, 나중 것은 밖에 둔다. 이건 [신뢰할 수 있는 RAG가 "충분한 컨텍스트인지 판단하고 모르면 기권"하는 것과](/blog/19-search-for-agents) 같은 정신이다. 더 넣는 게 답이 아니다.
